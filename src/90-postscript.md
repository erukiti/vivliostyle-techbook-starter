...
* テーマをいじるための知見を本に記したい
* Vivliostyleの、目次生成<span class="footnote">この本では無茶なhackをして、それっぽい目次にしていいます。通常出てくる目次だとエグいことになります。</span>に関する知見を本に記したい
* GitHub Actionsの説明
...
* かなりhackをしているのでなんとかする
* Mermaidに完全敗北したので、再トライする
* Type3フォント問題
* press-readyで、透明色があるとバグる件について
* コラムの先頭に手動で無理矢理全角スペースをいれないといけない問題

などが残る課題でしょう。Vivliostyleについての理解をもっと深めた上で、本を書く人が苦労しなくていいだけの**本当に必要な情報**を全部丸裸にして、完全に解析をしたいところです。
